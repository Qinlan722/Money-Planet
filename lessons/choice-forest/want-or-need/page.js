...
export function renderWantOrNeedBody(lesson, planet) {
  return `
    ${FONT_LINK}
    <section class="page-section lesson-page">
      <a class="back-link" href="/explore/${planet.id}?level=beginner">← 返回闯关地图 Back to Level Map</a>
      <div class="il-hero-banner il-hero-banner-forest">
        <div class="il-hero-eyebrow">${planet.zh} · ${planet.name} · 第 3 关</div>
